        ...
        <div className="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
          ...
          <div className="p-4 sm:p-10 text-center overflow-y-auto">
            ...
            <p className="text-gray-500 dark:text-neutral-500">
              ...
              Please{" "}
              <a
                className="inline-flex items-center gap-x-1.5 text-violet-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-violet-500"
                href="#"
