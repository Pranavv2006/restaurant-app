        ...
        <div id="hs-task-created-alert" className="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-task-created-alert-label">
            <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                ...
                <div className="p-4 sm:p-10 text-center overflow-y-auto">
                    ...
                    You can now log into your <a className="inline-flex items-center gap-x-1.5 text-violet-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-violet-500" href="#">personal account.</a>
                    </p>
