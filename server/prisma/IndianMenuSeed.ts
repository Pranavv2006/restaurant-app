...
const indianMenu = [
  ...
  },
  {
    ...
    category: "Non-Vegetarian", // Biryani can be both, but for this example, we will consider it non-vegetarian.
  },
  {
    name: "Rogan Josh",
  ...
  for (const restaurant of indianRestaurants) {
    ...
    for (let i = 0; i < toCreate; i++) {
      ...
      menuItems.push({
        ...
        category: item.category, // Changed from "Indian" to item.category
