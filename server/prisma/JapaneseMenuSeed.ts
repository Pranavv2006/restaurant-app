...
const japaneseMenu = [
  {
    ...
    category: "Non-Vegetarian", // Assumes sushi with fish; can be Vegetarian with veggie fillings
  },
  {
    name: "Ramen",
  ...
  },
  {
    ...
    category: "Vegetarian", // Udon can be vegetarian, but sometimes has a meat-based broth
  },
  {
    name: "Yakitori",
  ...
  },
  {
    ...
    category: "Non-Vegetarian", // Typically includes pork belly
  },
  {
    name: "Sashimi",
  ...
  },
  {
    ...
    category: "Non-Vegetarian", // Often contains fish or meat
  },
  {
    name: "Tonkatsu",
  ...
  for (const restaurant of japaneseRestaurants) {
    ...
    for (let i = 0; i < toCreate; i++) {
      ...
      menuItems.push({
        ...
        category: item.category, // Changed from "Japanese" to item.category
